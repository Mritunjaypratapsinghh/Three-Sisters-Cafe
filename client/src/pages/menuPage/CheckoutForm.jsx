...
const CheckoutForm = ({ price, cart }) => {
    ...
    const [isProcessingPayment, setIsProcessingPayment] = useState(false); // Add state to track payment processing

const handleSubmit = async (event) => {
    event.preventDefault();
    
    if (isProcessingPayment) {
        return; // Do nothing if payment is already in process
    }
    
    setIsProcessingPayment(true); // Set payment processing to true
