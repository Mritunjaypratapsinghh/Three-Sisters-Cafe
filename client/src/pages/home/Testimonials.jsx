            ...
            <div className='flex flex-col md:flex-row items-center  justify-between gap-12 '>
                ...
                <div className='md:w-1/2'>
                    <div className='text-left md:w-4/s'>
                        ...
                        "Exceptional service and mouthwatering dishes! Threesisters has redefined convenience without compromising on flavor. The diverse menu caters to all tastes, and the delivery is always prompt. Our family's favorite for online food orders in New Delhi!"
                        </blockquote>
