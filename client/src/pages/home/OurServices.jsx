      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            Experience the delectable offerings of ThreeSisters Cafe, where every dish is a fusion of European dessert flavors and contemporary culinary delights. Our menu is crafted to tantalize your taste buds and leave you craving for more.            </p>
