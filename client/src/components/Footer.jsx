...
const Footer = () => {
    ...
    <div className=' bg-stone-950'>
      <footer className="footer xl:px-24 py-4 px-4 bg-stone-950 text-base-content left-0 right-0 bottom-0 ">
        <aside>
          ...
          <p className='md:w-40 text-slate-500'>ThreeSisters Cafe & Co.<br /></p>
        </aside>
        <nav>
  ...
  <aside className="items-center grid-flow-col text-slate-800 mb-8">
    ...
    <p className='mt-5 text-slate-300'>Copyright © 2024 - All right reserved By ThreeSisters Cafe & Co.</p>
  </aside>
